            ...
            <div class="p-5 bg-slate-800 rounded-lg">
                <form method="POST" action="{{ route('account-names.store') }}">
                    ...
                    <div class="mt-3">
                        ...
                        <x-text-input id="name_bn" class="block mt-1 w-full" type="text" name="name_bn" :value="old('name_bn')" required autofocus autocomplete="name_bn" />
                    ...
                    <div class="mt-3">
                        ...
                        <select id="trans_type" name="trans_type" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
