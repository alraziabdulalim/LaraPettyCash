                    ...
                    <form method="POST" action="{{ route('transactions.update', $transaction) }}">
                        ...
                        <div class="mt-6">
                            ...
                            <select id="accounttype_id" name="accounttype_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                <option value="{{$accountType->id}}" {{ $accountType->id == $transaction->accountname->accounttype->id? 'selected' : '' }}>{{ $accountType->name_bn }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mt-3">
                            ...
                            <select id="accountcategory_id" name="accountcategory_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                <option value="{{$accountCategory->id}}" {{ $accountCategory->id == $transaction->accountname->accountcategory->id? 'selected' : '' }}>{{ $accountCategory->name_bn }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mt-3">
                            ...
                            <select id="accountname_id" name="accountname_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                <option value="{{$accountName->id}}" {{ $accountName->id == $transaction->accountname_id? 'selected' : '' }}>{{ $accountName->name_bn }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="mt-3">
                            ...
                            <textarea id="detail" name="detail" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required autofocus autocomplete="detail">{{ $transaction->detail }}</textarea>
